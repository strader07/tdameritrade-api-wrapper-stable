        ...
        if AUTH_METHOD == "AUTO":
            ...
            try:
                ...
                if browser.is_text_present(question1):
                    browser.find_by_id('secretquestion0').first.fill(myanswer1)

                elif browser.is_text_present(question2):
                    browser.find_by_id('secretquestion0').first.fill(myanswer2)

                elif browser.is_text_present(question3):
                    browser.find_by_id('secretquestion0').first.fill(myanswer3)

                elif browser.is_text_present(question4):
                    browser.find_by_id('secretquestion0').first.fill(myanswer4)
                ...
                print(e)
            try:
                browser.find_by_xpath('//label[@for="trustthisdevice0_0"]').first.click()
            except Exception as e:
                print(e)
            try:
                browser.find_by_id("accept").first.click() 
